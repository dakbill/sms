        ...
        <div class="box-content">
            <div class="row-fluid">
                <div class="bs-docs-example">
                    <form class=" form-horizontal" action="{{URL::route('admin#attempt-enroll-student')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                                        ...
                                        <div class="row-fluid">
                                            <div class="span5 ">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" id="os" name="gsrelation" placeholder="e.g. Special Friend" readonly="true">
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <label class="control-label" for="parent_photo">Avatar</label>
                                                        <div class="btn-group" >
                                                            ...
                                                            <input type="file" onchange="parent_preview_image(this)" name="gphoto" id="parent_photo" accept="image/*">
                                                            <script>
                                                            ...
                                                            <img id="parent_preview" src="{{asset('images/passport.png')}}" width="140px" height="140px">
                                                        </div>
                                                    </div>
                                                </div>
                                                </fieldset>
