            ...
            <div class="container-fluid">
                ...
                <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{URL::route('guardian#profile')}}">Profile</a></li>
                        <li class="divider"></li>
            ...
            <div class="well nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li><a class="ajax-link"
                           href="{{URL::route('guardian#pay-fees')}}"><i
                                class="icon-eye-open"></i><span class="hidden-tablet"> Pay Ward Fees</span></a></li>
                    <li><a class="ajax-link"
                           href="{{URL::route('guardian#time-table')}}"><i
                                class="icon-eye-open"></i><span class="hidden-tablet"> Ward Time Table</span></a></li>                                
                    <li><a class="ajax-link"
                           href="{{URL::route('guardian#calendar')}}"><i
