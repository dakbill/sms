<div>
    <ul class="breadcrumb">
        <li>
            <a href="<?php echo base_url() . $this->session->userdata('role') ?>">Home</a> <span
                class="divider">/</span>
        </li>
        <li>
            <a>View Timetable</a>
...
<table border="0" cellspacing="0" cellpadding="0" class="table table-bordered ">
    ...
    <thead>
    <tr>
        <td colspan="3" style="text-align:left;width:1.1542in; " class="TimeTable_A1"><p class="P4"><b>PREMEPEH COLLEGE</b></p>
        </td>
        <td style="text-align:left;width:1.1542in; " class="TimeTable_A1"><p class="Table_20_Contents">&nbsp;</p></td>
        <td style="text-align:left;width:1.1542in; " class="TimeTable_A1"><p class="Table_20_Contents">&nbsp;</p></td>
        <td style="text-align:left;width:1.1042in; " class="TimeTable_F1"><p class="Table_20_Contents">&nbsp;</p></td>
    </tr>
    <tr>
...
<!--iframe src="<?php echo base_url() . $this->session->userdata('role') ?>/get-timetable"  width="1000" height="600" ></iframe-->