...
<head>
	...
	<style type="text/css">
	  ...
	  <link rel="stylesheet" type="text/css" href="<?php  echo base_url(); ?>assets/css/fullcalendar.print.css">
	  ...
	  <link rel="stylesheet" type="text/css" href="<?php  echo base_url(); ?>assets/css/jquery.noty.css">
	  <link rel="stylesheet" type="text/css" href="<?php  echo base_url(); ?>assets/css/noty_theme_default.css">
	  <link rel="stylesheet" type="text/css" href="<?php  echo base_url(); ?>assets/css/elfinder.min.css">
	  <link rel="stylesheet" type="text/css" href="<?php  echo base_url(); ?>assets/css/elfinder.theme.css">
	  <link rel="stylesheet" type="text/css" href="<?php  echo base_url(); ?>assets/css/jquery.iphone.toggle.css">
	  <link rel="stylesheet" type="text/css" href="<?php  echo base_url(); ?>assets/css/opa-icons.css">
